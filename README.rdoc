...
The HIT will direct the Turk workers to the #new method URL of your model.  With the above request, the Turkers would be directed to the form at http://www.yourapp.com/surveys/new
