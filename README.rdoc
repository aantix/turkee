...
5. Allow sometime for the "Turkers" to respond to your HIT.
...
7. When a response is retrieved from Mechanical Turk, Turkee attempts to create a data row for the model specified
...
the assignment will automatically be approved. If you'd like to add your own custom approval method,
add the approve? instance method to your model.  E.g. :
