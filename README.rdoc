...
If you're upgrading Turkee (1.1.1 and prior):
...
URL.all do |url|
  Turkee::TurkeeTask.create_hit(host, hit_title, hit_description, UrlSurvey, num_assignments, reward, lifetime, qualifications = {}, params = {:url_id => url.id}, opts = {})
end
